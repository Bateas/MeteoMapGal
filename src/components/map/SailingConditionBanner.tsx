...
export function SailingConditionBanner() {
  ...
  return (
    <div
      className={`${isMobile ? 'fixed z-30' : 'absolute z-30'} top-3 left-1/2 -translate-x-1/2 pointer-events-auto`}
    >
      <div
        className={`flex items-center rounded-lg font-semibold shadow-lg ${
